...
<div className="__variable_20b187 group/spotlight relative">
  <div
    ...
    style={{
      background:
        "radial-gradient(600px at 642px 418px, rgba(29, 78, 216, 0.15), transparent 80%)"
    }}
  />
        ...
        >
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              . In my free time Ive also released an{/* */}{" "}
              <a
                className="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
                ...
                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="z-10 sm:order-2 sm:col-span-6">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      aria-label="583 stars on GitHub"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
              ...
              <li className="mb-12">
                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="z-10 sm:order-2 sm:col-span-6">
                    ...
                    <p className="mt-2 text-sm leading-normal">
                      An old portfolio site built with Gatsby with 6k+ stars and
                      3k+ forks
                    </p>
                    <a
                      className="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-teal-300 focus-visible:text-teal-300"
                      ...
                      target="_blank"
                      rel="noreferrer"
                      aria-label="6792 stars on GitHub"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
