        ...
        <div className="lg:flex lg:justify-between lg:gap-4">
          <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
            <div>
              ...
              <a href={bio.resume} target="_blank" rel="noreferrer" className="z-20 my-8 bg-teal-400/10 hover:bg-teal-200/10 transition text-teal-300 fill-teal-300 font-bold px-8 py-2 rounded-md inline-flex items-center gap-3">
